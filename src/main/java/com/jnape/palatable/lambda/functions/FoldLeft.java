...
public final class FoldLeft<A, B> extends TriadicFunction<DyadicFunction<B, A, B>, B, Iterable<A>, B> {

    @Override
    public final B apply(DyadicFunction<B, A, B> function, B initialAccumulation, Iterable<A> as) {
    ...
    public static <A, B> DyadicFunction<B, Iterable<A>, B> foldLeft(DyadicFunction<B, A, B> function) {
        return FoldLeft.<A, B>foldLeft().partial(function);
    }

    public static <A, B> MonadicFunction<Iterable<A>, B> foldLeft(DyadicFunction<B, A, B> function,

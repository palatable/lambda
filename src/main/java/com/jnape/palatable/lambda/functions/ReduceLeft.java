...
public final class ReduceLeft<A> extends DyadicFunction<DyadicFunction<A, A, A>, Iterable<A>, A> {
    ...
    public static <A> MonadicFunction<Iterable<A>, A> reduceLeft(DyadicFunction<A, A, A> function) {

 ...
 */
public final class Into7<A, B, C, D, E, F, G, H> implements Fn2<Fn7<A, B, C, D, E, F, G, H>, Tuple7<A, B, C, D, E, F, G>, H> {

    private static final Into7 INSTANCE = new Into7();

    @Override
    public H apply(Fn7<A, B, C, D, E, F, G, H> fn, Tuple7<A, B, C, D, E, F, G> tuple) {
    ...
    public static <A, B, C, D, E, F, G, H> Fn1<Tuple7<A, B, C, D, E, F, G>, H> into7(Fn7<A, B, C, D, E, F, G, H> fn) {
        return Into7.<A, B, C, D, E, F, G, H>into7().apply(fn);
    }

    public static <A, B, C, D, E, F, G, H> H into7(Fn7<A, B, C, D, E, F, G, H> fn, Tuple7<A, B, C, D, E, F, G> tuple) {
        return into7(fn).apply(tuple);
    }
}

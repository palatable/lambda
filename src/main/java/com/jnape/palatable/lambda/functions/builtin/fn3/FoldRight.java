...
public final class FoldRight<A, B> implements
        Fn3<Fn2<? super A, ? super Lazy<B>, ? extends Lazy<B>>, Lazy<B>, Iterable<A>, Lazy<B>> {
    ...
    @Override
    public Lazy<B> checkedApply(Fn2<? super A, ? super Lazy<B>, ? extends Lazy<B>> fn, Lazy<B> acc,
                                Iterable<A> as) {
    ...
    public static <A, B> Fn2<Lazy<B>, Iterable<A>, Lazy<B>> foldRight(
            Fn2<? super A, ? super Lazy<B>, ? extends Lazy<B>> fn) {
    ...
    public static <A, B> Lazy<B> foldRight(Fn2<? super A, ? super Lazy<B>, ? extends Lazy<B>> fn, Lazy<B> acc,
                                           Iterable<A> as) {

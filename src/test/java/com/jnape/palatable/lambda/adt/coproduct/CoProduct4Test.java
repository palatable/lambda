...
public class CoProduct4Test {
    ...
    public void converge() {
        Function<Double, CoProduct3<Integer, String, Boolean>> convergenceFn = x -> x.equals(1d) ? new CoProduct3<Integer, String, Boolean>() {
            @Override
            public <R> R match(Function<? super Integer, ? extends R> aFn, Function<? super String, ? extends R> bFn,
                ...
                ? new CoProduct3<Integer, String, Boolean>() {
            @Override
            public <R> R match(Function<? super Integer, ? extends R> aFn, Function<? super String, ? extends R> bFn,
                               Function<? super Boolean, ? extends R> cFn) {
                return bFn.apply("b");
        ...
        assertEquals(1, new CoProduct4<Integer, String, Boolean, Double>() {
            @Override
            public <R> R match(Function<? super Integer, ? extends R> aFn, Function<? super String, ? extends R> bFn,
        ...
        assertEquals("b", new CoProduct4<Integer, String, Boolean, Double>() {
            @Override
            public <R> R match(Function<? super Integer, ? extends R> aFn, Function<? super String, ? extends R> bFn,
                               Function<? super Boolean, ? extends R> cFn, Function<? super Double, ? extends R> dFn) {
                return dFn.apply(2d);
        ...
        assertEquals(false, new CoProduct4<Integer, String, Boolean, Double>() {
            @Override
            public <R> R match(Function<? super Integer, ? extends R> aFn, Function<? super String, ? extends R> bFn,
                               Function<? super Boolean, ? extends R> cFn, Function<? super Double, ? extends R> dFn) {
                return dFn.apply(3d);
